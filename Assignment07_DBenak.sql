...
-- 2023-11-23,DBenak,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_DBenak')
	 Begin 
	  Alter Database [Assignment07DB_DBenak] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_DBenak;
	 End
	Create Database Assignment07DB_DBenak;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_DBenak;
